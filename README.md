...
- homefiles
  ...
  - [Link to the README.md](https://github.com/TaylorR-25/dotfiles/blob/main/homefiles/README.md)
- sys-installs
  - Clone the repo into your terminal.
  - And then run the `singulatrityscript`
  - [Link to the README.md](https://github.com/TaylorR-25/dotfiles/blob/main/sys-installs/README.md)
- vim-config
  - Clone the repo into your terminal.
